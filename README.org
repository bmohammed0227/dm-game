...
* TODO [0/7] Tasks
  ...
  5) [ ] Faire générer les clients
     ...
     #+end_comment
  6) [ ] Implementer l'algorithme Apriori
     #+begin_comment
...
* Tileset
  Credits : [[dribbble.com/grlmc][grlmc from Dribble]] 
  
[[./tiles/tileset.png]]

* Sprites
  Made using [[www.mmorpgmakerxb.com/p/characters-sprites-generator][mmorpgmakerxb]]   
 
** Character 1
   [[./sprites/character_1/character_1.png]]

** Character 2
   [[./sprites/character_2/character_2.png]]

** Character 3
   [[./sprites/character_3/character_3.png]]

** Character 4
   [[./sprites/character_4/character_4.png]]
